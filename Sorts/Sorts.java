...
class Sorts
{
  ...
  private static int findmax(Integer [] list, int end)
  {
    int maxpos=0;
    for(int j=1; j<=end; j++)
    {
  ...
  //--------------------------------------------------------
  public static void insertion(Integer [] list, int gap, int offset)
  {
  ...
  //--------------------------------------------------------
  private static int partition(Integer [] list, int start, int stop)
  // returns the location of the pivot after partitioning
  {
    Integer pivot=list[stop];
  ...
  private static void quickhelp(Integer [] list, int start, int stop)
  {
    ...
    {
      if(list[start]>(list[stop])) // if out of order
